...
SECRET_KEY = 'django-insecure-&qgrnibx9$8!l*)a8%=o3eknxmt$w=o*kxq!1j9&v)$91&a5=g'
...
SIMPLE_JWT = {
    "USER_ID_FIELD": "user_id",   # 👈 match your custom user PK
    "USER_ID_CLAIM": "user_id",   # 👈 make sure the token stores this claim
